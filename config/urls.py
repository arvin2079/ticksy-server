...
urlpatterns = [
    ...
    path('users/api/', include('users.api.urls', 'auth-api')),
    ...
    # Optional UI:
    path('swagger2/', SpectacularSwaggerView.as_view(url_name='schema'), name='swagger-ui'),
    path('redoc2/', SpectacularRedocView.as_view(url_name='schema'), name='redoc'),
