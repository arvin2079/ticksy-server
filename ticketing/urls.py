...
urlpatterns = [
    ...
    path('ticket/<int:id>/internal-transition/', TicketInternalTransitionUpdateAPIView.as_view(), name='ticket-update-internal-transition'),
    path('ticket/<int:id>/external-transition/', TicketExternalTransitionUpdateAPIView.as_view(), name='ticket-update-external-transition'),
